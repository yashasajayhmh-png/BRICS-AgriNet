...
import { getFirestore, doc, getDocFromServer, collection, getDocs, setDoc, updateDoc, deleteDoc, query, orderBy, limit, onSnapshot } from 'firebase/firestore';
...
export async function testConnection(): Promise<boolean> {
  try {
    ...
    if (error instanceof Error && error.message.includes('the client is offline')) {
      ...
      console.info('Firebase connection check verified endpoint access.');
    }
    return false;
  }
}
